...
ApplicationWindow {
    ...
    FontLoader {
        ...
        Component.onCompleted: {
                console.log("FontAwesome font name:", name)
                console.log("FontAwesome font status:", status)
            }
    }
    ...
    function getArtist() {
        if (musicModel.count > 0) {
            ...
            artistName = artist === "" ? "Unknown Artist" : artist.length
                                         > 40 ? artist.slice(
                                                    0, 39) + " ..." : artist
        }
    }
            ...
            ColumnLayout {
                ...
                Label {
                    ...
                    Timer {
                        ...
                        repeat: true
                        onTriggered: {
                            currentDate.text = Qt.formatDateTime(
                                        new Date(), "dddd | MMM dd , yyyy")
                        }
                    }
                }
            }
    ...
    function distance(meters) {
        return meters >= 1000 ? (meters / 1000.).toFixed(
                                    3) + " Km" : meters.toFixed(0) + " m"
    }

    property var updater: ServicesManager.contentUpdater(
                              ContentItem.Type.RoadMap)
    Component.onCompleted: {
        root.showMaximized()
        ...
        ServicesManager.settings.allowInternetConnection
                = true // enable connection to online services
    ...
    RowLayout {
        ...
        Page {
            ...
            TSlider {
                ...
                stepSize: 1
                from: 0
                to: navigation.active ? navigation.currentInstruction.traveledDistance
                                        + navigation.currentInstruction.remainingTravelDistance : 100
            ...
            RowLayout {
                ...
                ColumnLayout {
                    Label {
                        text: distance(
                                  navigation.currentInstruction.remainingTravelDistance)
                        Layout.alignment: Qt.AlignHCenter
                        font.pixelSize: 18
                        color: "white"
                        font.family: "Montserrat"
        ...
        ColumnLayout {
            ...
            Pane {
                ...
                ColumnLayout {
                    ...
                    IconButton {
                        visible: ServicesManager.settings.connected
                                 && !navigation.active
                        implicitHeight: 55
                        implicitWidth: 55
                        radius: 16
...
//                                    color: "white"
//                                    text: distance(
//                                              navigation.currentInstruction.distanceToNextTurn)
//                                }
//                                Label {
//                                    Layout.alignment: Qt.AlignLeft
//                                    color: "white"
...
//                                Label {
//                                    text: distance(
//                                              navigation.currentInstruction.traveledDistance)
//                                    Layout.alignment: Qt.AlignLeft
//                                    font.pixelSize: 18
//                                    color: "white"
//                                    font.family: "Montserrat"
...
//                                Slider {
//                                    from: 0
//                                    to: navigation.currentInstruction.traveledDistance
//                                        + navigation.currentInstruction.remainingTravelDistance
...
//                                              navigation.currentInstruction.remainingTravelTime) //navigation.currentInstruction.nextSpeedLimitVariation()
...
//                                        var secondsStr = remainingMinutes
...
//                }
                Map {
                    ...
                    center: QtPositioning.coordinate(28.7041, 77.1025) // Default center position
                    zoomLevel: 14

                    // Add MapItemView for routing
                    MapItemView {
                        model: routeModel
                        delegate: MapRoute {
                            route: routeData
            ...
            RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    ...
                                    font.pixelSize: 18
                                    text: musicTitle_.length > 35 ? musicTitle_.slice(
                                                                        0,
                                                                        35) + "..." : musicTitle_
                                }
                                ...
                                RowLayout {
                                    ...
                                    Slider {
                                        ...
                                        value: playerDuration
                                               === 0 ? 0 : (playerPosition * 100) / playerDuration
                                        Layout.alignment: Qt.AlignHCenter
                                    }
                                    AppIcon {
                        ...
                        RowLayout {
                            ...
                            IconButton {
                                ...
                                implicitWidth: 55
                                radius: 16
                                setIconColor: mainQmlApp.repeatIndex
                                              === 0 ? foreColor : Theme.checkedIconColor
                ...
                Page {
                    ...
                    BigForecastIcon {
                        ...
                        minText: (model.hasValidWeather ? model.weather.minTemperature : "??")
                        bottomText: (model.hasValidWeather ? model.weather.weatherDescription : "No weather data")
                        dateText: (model.hasValidWeather ? model.weather.dayOfWeek : "??")
